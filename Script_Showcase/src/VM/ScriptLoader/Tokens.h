...
#define STORE_ARRAY_INDEX_TOKEN "StoreArrayIndex"
#define LOAD_ARRAY_INDEX_TOKEN "LoadArrayIndex"
#define INVOKE_NATIVE_TOKEN "InvokeNative"
#define INVOKE_MANAGED_TOKEN "InvokeManaged"
...
#define ALLOCATE_OBJECT_ARRAY_TOKEN "AllocateObjectArray"
